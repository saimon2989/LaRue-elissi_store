...
(function( $ ) {
    ...
    geckoShopify.refresh_ins = function (_this) {
      ...
      if ( data != null && data != '' ) {
           ...
           if (acc == 'ins_19041994') {
            ...
            var ajaxUrl = 'https://graph.instagram.com/me/media?fields=id,media_type,media_url,permalink,thumbnail_url,caption,children&access_token='+acc;
           }
           $.ajax({
             url: ajaxUrl,
             type: 'GET',
   ...
   //           if (index >= limit) return 0;
   //           //console.log(el);
   //           html += '<div class="cl_nt_'+index+' col_ins col-'+clmb+' col-md-'+cltb+' col-lg-'+cl+' item pr"><a data-no-instant rel="nofollow" class="db pr oh" href="'+el.link+'" target="' + target + '"><div class="lazyloadt4s nt_bg_lz pr_lazy_img" data-bgset="' + el.images.thumbnail.url + ' 150w,' + el.images.low_resolution.url + ' 320w,' + el.images.standard_resolution.url + ' 640w" data-sizes="auto"></div><div class="info pa tc flex ts__03 fl_center al_center op__0 t__0 l__0 r__0 b__0 h__100 pe_none"><span class="pr cw mr__5 ml__5"><i class="facl facl-heart-o mr__5"></i>'+el.likes.count+'</span><span class="pr cw"><i class="facl facl-comments-o mr__5"></i>'+el.comments.count+'</span></div></a></div>';
   //        });
